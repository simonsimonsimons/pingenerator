...
export default async function handler(req, res) {
  ...
  try {
    ...
    const apiRes = await fetch(API_ENDPOINT, {
      ...
      body: JSON.stringify({
        instances: [{
          // HIER WIRD DER PROMPT ZUSAMMENGESETZT
          prompt: `Ein ansprechendes Pinterest-Thumbnail für einen Blogartikel. Das Bild soll prominent den Text "${prompt}" enthalten. Moderner, ästhetischer Stil mit sanften Pastellfarben.`
        }],
